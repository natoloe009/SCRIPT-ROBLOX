...
local touchInput = UserInputService.TouchEnabled and UserInputService:GetTouchState() or nil
...
scrollThumbFrame.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.Touch then
        ...
        doTick()
        local Connection = scrollThumbFrame.InputEnded:Connect(function(inputEnded)
